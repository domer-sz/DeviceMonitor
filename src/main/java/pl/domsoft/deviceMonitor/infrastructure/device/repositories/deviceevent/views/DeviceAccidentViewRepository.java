 ...
 */
@Repository
public interface DeviceAccidentViewRepository extends PagingAndSortingRepository<DeviceAccidentView, String>{
    Page<DeviceAccidentView> findAllByDeviceId(String deviceId, Pageable pageable);
}
